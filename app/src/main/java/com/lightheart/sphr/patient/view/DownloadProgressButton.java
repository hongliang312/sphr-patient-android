...
public class DownloadProgressButton extends ProgressBar implements View.OnClickListener {
    ...
    private void obtainStyledAttributes(Context context, AttributeSet attrs) {
        ...
        mLoadingTextColor = ta.getColor(R.styleable.DownloadProgressButton_loading_text_color, context.getResources().getColor(R.color.blue_text_007dff));
        ...
        mTextSize = ta.getDimension(R.styleable.DownloadProgressButton_download_textSize, context.getResources().getDimension(R.dimen.small));
        ta.recycle();
    }
